# -*- coding: utf-8 -*-
"""
Created on Wed May 16 10:03:30 2018
...
h_conv1 =tf.contrib.layers.conv2d(x_image,32,[5,5],1,'SAME',activation_fn=tf.nn.relu)
...
nt_hpool2 = tf.contrib.layers.avg_pool2d(h_pool2,[7,7],stride=7,padding='SAME')
    ...
    for i in range(200):#20000
      ...
      if i%20 == 0:
        train_accuracy = accuracy.eval(feed_dict={
            x:batch[0], y: batch[1]},session=sess)
